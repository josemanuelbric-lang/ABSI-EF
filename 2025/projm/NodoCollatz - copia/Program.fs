...
let main argv =
    ...
    for i in 0 .. finalRes.Count - 1 do
        ...
        if rutasR > 0 then
            ...
            resumenSimetria.Add(sprintf "NIVEL %-4d RpartD: %-8d LDD: %-8d RDD+LDppart: %-8d" i rutasR isduplicateL (isduplicateL+rutasR))
    sb.AppendLine("\n" + String('=', 60)) |> ignore
    ...
    // Mostrar en consola el resumen final
